...
//ChangeNotifier  , dinleyicilerine değişiklikleri bildirmek istediğimizde bildirimler sağlayan bir sınıftır. 
//notifyListeners() Bu, ChangeNotifier'ı genişleten ve sınıfta bir değişiklik olduğunda yöntemini çağıran bir sınıfa abone olabileceğiniz anlamına gelir .
// Bu çağrı, bağlı tüm dinleyicileri bilgilendirecektir. 
//ChangeNotifier, Flutter'a özgüdür ve çoğunlukla Sağlayıcı ve RiverPod paketleriyle birlikte kullanılır.
